...
@section('content')
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto lg:py-0">
        <h1 class="flex items-center mb-6 text-4xl font-semibold text-gray-900 dark:text-white">
            Behin Start
        </h1>
        <div
...
{{--                        <a href="#" class="text-sm font-medium hover:underline hover:text-blue-500">--}}
{{--                            Forgot password ?--}}
{{--                        </a>--}}
                    </div>
                    <button type="submit"
